      ...
      <DialogContent className="bg-primary-900 border-primary-700 sm:max-w-[625px]">
        ...
        <form onSubmit={handleSubmit} className="grid gap-4 py-4">
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="name" className="text-primary-100 text-right">
              Name
            </Label>
            <Input
              id="name"
              ...
              className="bg-primary-800 border-primary-700 col-span-3 text-white"
              required
            />
          </div>

          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="description" className="text-primary-100 text-right">
              Description
            </Label>
            <Textarea
              id="description"
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="date" className="text-primary-100 text-right">
              Date
            </Label>
            <Popover>
              <PopoverTrigger asChild>
                <Button
                  variant={"outline"}
                  className={cn(
                    "bg-primary-800 border-primary-700 col-span-3 justify-start text-left font-normal text-white",
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="type" className="text-primary-100 text-right">
              Type
            </Label>
            <Select onValueChange={(value) => setType(value as ActivityType)} value={type}>
              <SelectTrigger className="bg-primary-800 border-primary-700 col-span-3 text-white">
                ...
                {Object.values(ActivityType).map((activityType) => (
                  <SelectItem key={activityType} value={activityType}>
                    <div className="flex items-center">
                      <div
                        className={`bg- mr-3 h-3 w-3 shrink-0 rounded-full${ACTIVITY_TYPES_COLOR[activityType]}-500`}
                      />
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="category" className="text-primary-100 text-right">
              Category
            </Label>
            <Select
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="subcategory" className="text-primary-100 text-right">
              Subcategory
            </Label>
            <Select
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="amount" className="text-primary-100 text-right">
              Amount
            </Label>
            <Input
              id="amount"
              ...
              className="bg-primary-800 border-primary-700 col-span-3 font-mono text-white"
              required
              step="0.01"
            />
          </div>
