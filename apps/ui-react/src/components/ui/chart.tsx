...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "grid min-w-[8rem] items-start gap-2 rounded-sm border bg-popover px-3 py-2 font-sans text-xs shadow-none",
        className,
      )}
    >
                  ...
                  >
                    <div className="grid gap-1.5">
                      ...
                      <span className="text-muted-foreground">
                        {String(itemConfig?.label ?? item.name ?? "").replace(
                          /^\w/,
