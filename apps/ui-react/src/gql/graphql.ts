...
export type WorkspaceDataQuery = {
  workspace: {
    id: UUID;
    name: string;
    startingDate: string;
  ...
  activities: Array<{
    ...
    amount: number;
    status: string;
    transactions: Array<{ id: UUID; amount: number; fromAccount: UUID; toAccount: UUID }>;
    movements: Array<{ id: UUID; movement: UUID; amount: number }>;
  }>;
  activityCategories: Array<{ id: UUID; name: string; type: string }>;
  activitySubcategories: Array<{ id: UUID; name: string; category: UUID }>;
  accounts: Array<{
    id: UUID;
    name: string;
    type: string;
  ...
  movements: Array<{
    ...
    name: string;
    status: string;
    activities: Array<{ id: UUID; activity: UUID; amount: number }>;
  }>;
  projects: Array<{
    id: UUID;
    name: string;
...
export type CreateWorkspaceMutation = {
  createWorkspace: {
    ...
    startingDate: string;
    createdAt: string;
    users: Array<{ id: string; email: string; name: string; image: string | null }>;
  };
};
...
export const WorkspaceDataDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "WorkspaceData" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "workspace" } },
          type: {
            kind: "NonNullType",
      ...
      selectionSet: {
        ...
        selections: [
            ...
            arguments: [
              {
                ...
                value: { kind: "Variable", name: { kind: "Name", value: "workspace" } },
              },
            ],
            selectionSet: {
              kind: "SelectionSet",
                ...
                { kind: "Field", name: { kind: "Name", value: "project" } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: "Field", name: { kind: "Name", value: "fromAccount" } },
                      { kind: "Field", name: { kind: "Name", value: "toAccount" } },
                    ],
                  },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "movements" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "id" } },
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "activityCategories" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "workspaceId" },
          ...
          },
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "startingCashBalance" } },
                { kind: "Field", name: { kind: "Name", value: "movements" } },
              ],
            },
          },
          {
...
} as unknown as DocumentNode<WorkspaceDataQuery, WorkspaceDataQueryVariables>;
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "startingBalance" } },
          type: { kind: "NamedType", name: { kind: "Name", value: "Float" } },
        },
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "startingCashBalance" } },
          type: { kind: "NamedType", name: { kind: "Name", value: "Float" } },
        },
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "movements" } },
        ...
        selections: [
          {
            ...
            arguments: [
              ...
              },
              {
                ...
                value: { kind: "Variable", name: { kind: "Name", value: "startingBalance" } },
              },
              {
                kind: "Argument",
                name: { kind: "Name", value: "startingCashBalance" },
                value: { kind: "Variable", name: { kind: "Name", value: "startingCashBalance" } },
              },
              {
                kind: "Argument",
                name: { kind: "Name", value: "movements" },
                value: { kind: "Variable", name: { kind: "Name", value: "movements" } },
              },
            ],
            selectionSet: {
              kind: "SelectionSet",
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "movement" } },
          type: { kind: "NamedType", name: { kind: "Name", value: "ActivityMovementInput" } },
        },
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "name" } },
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "transactions" } },
          type: {
            kind: "ListType",
            type: {
              kind: "NonNullType",
        ...
        selections: [
          {
            ...
            arguments: [
              ...
              },
              {
                ...
                value: { kind: "Variable", name: { kind: "Name", value: "movement" } },
              },
              {
                kind: "Argument",
                name: { kind: "Name", value: "name" },
              ...
              },
              {
                kind: "Argument",
                name: { kind: "Name", value: "transactions" },
                value: { kind: "Variable", name: { kind: "Name", value: "transactions" } },
              },
              {
                kind: "Argument",
                name: { kind: "Name", value: "type" },
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "fromAccount" } },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "UUID" } },
          },
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "toAccount" } },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "UUID" } },
          },
        ...
        selections: [
          {
            ...
            arguments: [
              ...
              },
              {
                ...
                value: { kind: "Variable", name: { kind: "Name", value: "fromAccount" } },
              },
              {
                kind: "Argument",
                name: { kind: "Name", value: "toAccount" },
                value: { kind: "Variable", name: { kind: "Name", value: "toAccount" } },
              },
            ],
            selectionSet: {
              kind: "SelectionSet",
...
} as unknown as DocumentNode<AddTransactionMutation, AddTransactionMutationVariables>;
...
export const CreateActivityCategoryDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "CreateActivityCategory" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
  ...
  CreateActivityCategoryMutationVariables
>;
export const UpdateActivityCategoryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "UpdateActivityCategory" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
  ...
  UpdateActivityCategoryMutationVariables
>;
export const DeleteActivityCategoryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "DeleteActivityCategory" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
...
>;
export const CreateActivitySubCategoryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "CreateActivitySubCategory" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
  ...
  CreateActivitySubCategoryMutationVariables
>;
export const UpdateActivitySubCategoryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "UpdateActivitySubCategory" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
  ...
  UpdateActivitySubCategoryMutationVariables
>;
export const DeleteActivitySubCategoryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "DeleteActivitySubCategory" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
  ...
  DeleteActivitySubCategoryMutationVariables
>;
...
} as unknown as DocumentNode<CreateMovementMutation, CreateMovementMutationVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "UpdateMovement" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<UpdateMovementMutation, UpdateMovementMutationVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "DeleteMovement" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<DeleteMovementMutation, DeleteMovementMutationVariables>;
export const CreateMovementActivityDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "CreateMovementActivity" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "workspace" } },
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "movementId" } },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "UUID" } },
          },
        ...
        selections: [
          {
            ...
            arguments: [
              ...
              {
                kind: "Argument",
                name: { kind: "Name", value: "movementId" },
...
>;
export const UpdateMovementActivityDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "UpdateMovementActivity" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
  ...
  UpdateMovementActivityMutationVariables
>;
export const DeleteMovementActivityDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "DeleteMovementActivity" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "startingDate" } },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "Date" } },
          },
...
} as unknown as DocumentNode<WorkspacesQuery, WorkspacesQueryVariables>;
