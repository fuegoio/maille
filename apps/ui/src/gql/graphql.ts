...
export type Contact = {
  ...
  id: Scalars['UUID']['output'];
  liabilityAccount: Maybe<Scalars['UUID']['output']>;
};
...
export type Liability = {
  ...
  amount: Scalars['Float']['output'];
  date: Scalars['Date']['output'];
  linkId: Scalars['UUID']['output'];
  linkedAmount: Maybe<Scalars['Float']['output']>;
  name: Scalars['String']['output'];
  status: Scalars['String']['output'];
};
...
export type CreateActivityMutation = { createActivity: { id: UUID, number: number, liabilities: Array<{ account: UUID, linkId: UUID }> | null } };
...
export type AddTransactionMutation = { addTransaction: { id: UUID, liabilities: Array<{ account: UUID, linkId: UUID }> | null } };
...
export type UpdateTransactionMutation = { updateTransaction: { id: UUID, liabilities: Array<{ account: UUID, linkId: UUID }> | null } };
