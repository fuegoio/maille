...
export interface CreateAssetDepreciationEvent extends BaseSyncEvent {
  ...
  payload: {
    ...
    basis: number;
    months: number;
    /** ISO date: the 1st of the first depreciated month. */
    startMonth: string;
...
export interface UpdateAssetDepreciationEvent extends BaseSyncEvent {
...
export interface DeleteAssetDepreciationEvent extends BaseSyncEvent {
